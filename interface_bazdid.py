...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox_noeAnjamKar.setItemText(7, _translate("MainWindow", "تحدید حدود عمومی"))
        self.comboBox_noeAnjamKar.setItemText(8, _translate("MainWindow", "تحدید حدود اختصاصی"))
        self.comboBox_noeAnjamKar.setItemText(9, _translate("MainWindow", "تعیین باقی مانده"))
        self.comboBox_noeAnjamKar.setItemText(10, _translate("MainWindow", "قانون تعیین تکلیف"))
        self.comboBox_noeAnjamKar.setItemText(11, _translate("MainWindow", "قانون الحاق و ساماندهی"))

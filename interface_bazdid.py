...
"")
        ...
        self.checkBox_viaDate_2 = QtWidgets.QCheckBox(self.groupBox_2)
        self.checkBox_viaDate_2.setStatusTip("")
        self.checkBox_viaDate_2.setObjectName("checkBox_viaDate_2")
        self.horizontalLayout_5.addWidget(self.checkBox_viaDate_2)
...
"}")
        ...
        MainWindow.setTabOrder(self.lineEdit_dateYear, self.checkBox_viaDate_2)
        MainWindow.setTabOrder(self.checkBox_viaDate_2, self.lineEdit_moteqazi_2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox_viaDate_2.setToolTip(_translate("MainWindow", "بازیابی سوابق پرونده به تاریخ"))
        self.checkBox_viaDate_2.setText(_translate("MainWindow", "بازیابی نام متقاضی"))

...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit_moteqazi.setToolTip(_translate("MainWindow", "<html><head/><body><p dir=\'rtl\'><span style=\" font-weight:600;\">نام </span><span style=\" font-weight:600; color:#aa00ff;\">متقاضی</span><span style=\" font-weight:600;\"> این پلاک را وارد کنید</span></p></body></html>"))
        ...
        self.checkBox_nextDays.setText(_translate("MainWindow", "به بعد"))
        self.radioButton_viaName.setToolTip(_translate("MainWindow", "بازیابی سوابق ثبت شده به نام متقاضی"))
        self.radioButton_viaName.setText(_translate("MainWindow", "بازیابی نام متقاضی"))
        ...
        self.pushButton_getExcel.setText(_translate("MainWindow", "دریافت فایل"))

...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox_noeAnjamKar.setItemText(3, _translate("MainWindow", "افراز"))
        self.comboBox_noeAnjamKar.setItemText(4, _translate("MainWindow", "تفکیک آپارتمان"))
        self.comboBox_noeAnjamKar.setItemText(5, _translate("MainWindow", "تفکیک عرصه"))
        self.comboBox_noeAnjamKar.setItemText(6, _translate("MainWindow", "تجمیع"))
        self.comboBox_noeAnjamKar.setItemText(7, _translate("MainWindow", "قانون تعیین تکلیف"))
        self.comboBox_noeAnjamKar.setItemText(8, _translate("MainWindow", "قانون الحاق و ساماندهی"))
        self.comboBox_noeAnjamKar.setItemText(9, _translate("MainWindow", "تحدید حدود اختصاصی"))
        self.comboBox_noeAnjamKar.setItemText(10, _translate("MainWindow", "تحدید حدود عمومی"))
        self.comboBox_noeAnjamKar.setItemText(11, _translate("MainWindow", "تعیین باقیمانده"))
        self.comboBox_noeAnjamKar.setItemText(12, _translate("MainWindow", "ماده 45"))
        self.comboBox_noeAnjamKar.setItemText(13, _translate("MainWindow", "بازدید"))
        self.comboBox_noeAnjamKar.setItemText(14, _translate("MainWindow", "سایر"))
        ...
        self.comboBox_naghshebardar.setItemText(1, _translate("MainWindow", "اسماعیل دولتی"))
        self.comboBox_naghshebardar.setItemText(2, _translate("MainWindow", "سایر"))

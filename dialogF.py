...
class Ui_Dialog(QtWidgets.QDialog):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(280, 105)
        Dialog.setMinimumSize(QtCore.QSize(280, 105))
        Dialog.setMaximumSize(QtCore.QSize(280, 105))
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "خطا"))
        self.label.setText(_translate("Dialog", "نام کاربری یا رمز ورود اشتباه است!"))
        self.btn_exit.setText(_translate("Dialog", "خروج"))
        self.btn_try.setText(_translate("Dialog", "سعی مجدد"))
